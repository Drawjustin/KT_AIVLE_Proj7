...
def get_hospital(request: str,latitude: float,longitude: float, the_number_of_hospital: int = 3):
    path=''
    ...
    if predicted_class <= 2 :
        result = recommend_hospital(path, emergency, latitude, longitude, c_id, c_key, the_number_of_hospital)
        print({
        "summary": summary,
    ...
    return {
        "summary": summary,
        "predictedClass": int(predicted_class+1),
        "result": result
        } 